...
| **Rule Templates & Machine Learning Behavioral Analytics** | ML Behavior Analytics / Threat Intelligence | Medium | Initial Access, Persistence, Lateral Movement | Pre-built Sentinel templates including ML-driven behavioral profiling for anomalous RDP and SSH logins, alongside Microsoft Defender Threat Intelligence indicator matching. |
