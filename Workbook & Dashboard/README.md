...
|---|---|---|
| [SOC Overview Dashboard](#-1-soc-overview-dashboard) | Provides a high-level view of the SOC environment | Incidents, severity, affected hosts, attack activity |
...
| [Incident Response & Automation Dashboard](#-3-incident-response--automation-dashboard) | Tracks incident handling and SOC automation | Incident lifecycle, assignments, playbooks, response activity |
